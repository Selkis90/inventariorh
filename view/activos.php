...
<ul>
    <li><a href="create_activos.php">Crear Activo</a></li>
    <!-- Enlace para acceder a la página de creación de un nuevo activo -->
    <li><a href="view_activos.php">Ver Activos</a></li> <!-- Enlace para visualizar la lista de activos existentes -->
    <li><a href="update_activos.php">Actualizar Activos</a></li>
    <!-- Enlace para acceder a la página de actualización de activos -->
    <li><a href="delete_activos.php">Eliminar Activos</a></li>
    <!-- Enlace para acceder a la página de eliminación de activos -->
</ul>
